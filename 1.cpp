...
void drawFigure(unsigned long figure, std::vector<float> color, std::vector<std::pair<float, float>> coordinates) {
...
void drawCircle(std::vector<float> color, float centerX, float centerY, float radius, int segments) {
    ...
    drawFigure(GL_POLYGON, color, circleVertices);
}
...
void display() {
    ...
    drawFigure(GL_QUADS, {skyColor[0], skyColor[1], skyColor[2]}, {{-1, 0}, {1, 0}, {1, 1}, {-1, 1}});
    drawFigure(GL_QUADS, {0.0, 0.8, 0.0}, {{-1, 0}, {1, 0}, {1, -1}, {-1, -1}});
    drawFigure(GL_QUADS, {0.7, 0.3, 0}, {{-0.125, 0}, {0.125, 0}, {0.125, 0.25}, {-0.125, 0.25}});
    drawFigure(GL_TRIANGLES, {0.7, 0.7, 0}, {{-0.15, 0.25}, {0, 0.4}, {0.15, 0.25}});
    drawFigure(GL_TRIANGLES, {0, 0.6, 0}, {{-0.85, 0.40}, {-0.7, 0.50}, {-0.55, 0.40}});
    drawFigure(GL_TRIANGLES, {0, 0.6, 0}, {{-0.85, 0.35}, {-0.7, 0.45}, {-0.55, 0.35}});
    drawFigure(GL_QUADS, {0.6, 0.3, 0}, {{-0.73, 0}, {-0.67, 0}, {-0.67, 0.35}, {-0.73, 0.35}});
    drawFigure(GL_TRIANGLES, {0, 0.6, 0}, {{0.75, 0.50}, {0.6, 0.60}, {0.45, 0.50}});
    drawFigure(GL_TRIANGLES, {0, 0.6, 0}, {{0.75, 0.45}, {0.6, 0.55}, {0.45, 0.45}});
    drawFigure(GL_QUADS, {0.6, 0.3, 0}, {{0.63, 0}, {0.57, 0}, {0.57, 0.45}, {0.63, 0.45}});
